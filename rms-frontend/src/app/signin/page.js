      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white backdrop-blur-xl rounded-4xl shadow-2xl border border-gray-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              type="email"
              className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-gray-500 outline-none"
          ...
          <button
            type="submit"
            className="w-full p-3 mt-2 text-white bg-gray-900 rounded-lg hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 transition duration-300"
          >
            Login
          </button>
        </form>
